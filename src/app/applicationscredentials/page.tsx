...
import Apicontent from '../home/apicontent';
import Application from '../home/application';
import Blogscourse from '../home/blogscourse';
import Hackathon from '../home/hackathon';
import Profile from '../home/profile';
import Updatepro from '../home/updatepro';
import AllInclusiveIcon from '@mui/icons-material/AllInclusive';
import PlayCircleOutlineIcon from '@mui/icons-material/PlayCircleOutline';
import AdUnitsIcon from '@mui/icons-material/AdUnits';
import Credentails from '../home/credentails';

const Page = () => {
  const [anchorEl, setAnchorEl] = useState<null | HTMLElement>(null);
  const [selectedSection, setSelectedSection] = useState<string>('Credentails');
    ...
    <div className={styled.mainnav}>
      <div className={styled.navbar}>
        ...
        <div className={styled.sunstoneheading}>
          <Image src="/Images/sunstoneicon.png" alt="sunstone" width={30} height={30} />
          ...
          <div style={{ marginTop: '93%', marginLeft: '7%' }}>
            <div className={styled.update}>
              <div className={styled.updatebox}>
                <Image className={styled.updatestar} src="/Images/staricon.png" alt="star" width={30} height={30} />
                <p className={styled.updatetext}>
                  Upgrade to Sunstone <br /> Pro member
                </p>
                <p className={styled.updatetextwo}>
        ...
        <div>
          <Button onClick={handleClick}>
            <Avatar className={styled.dropdown}>
              <Image className={styled.userimg} src="/Images/user.svg" alt="User" width={30} height={30} />
            </Avatar>
          </Button>
          <Menu
            anchorEl={anchorEl}
            ...
            onClose={handleClose}
            style={{ width: '340px', marginLeft: '-6%' }}
          >
        ...
        <div className={styled.sidebar}>
          <div className={styled.apps}>
            <div className={styled.sidebaenames}>
              <div
                className={`${styled.namebackground} ${
                  selectedSection === 'home' ? styled.selectedOption : ''
                }`}
                onClick={() => handleSectionClick('home')}
              >
                <Image src="/Images/home.svg" alt="homeimg" width={24} height={24} />
                <p className={styled.homenames}>Home</p>
              </div>
              <div
                className={`${styled.namebackground} ${
                  selectedSection === 'Apicontent' ? styled.selectedOption : ''
                }`}
                onClick={() => handleSectionClick('Apicontent')}
              >
                <Image src="/Images/bookicon.svg" alt="book" width={24} height={24} />
                <p className={styled.homenames}>API Docs</p>
              </div>
              <div
                className={`${styled.namebackground} ${
                  selectedSection === 'Application' ? styled.selectedOption : ''
                }`}
                onClick={() => handleSectionClick('Application')}
              >
                <Image src="/Images/appsicon.svg" alt="apps" width={24} height={24} />
                <p className={styled.homenames}>Applications</p>
              </div>
              <div
                className={`${styled.namebackground} ${
                  selectedSection === 'Blogsandcourse' ? styled.selectedOption : ''
                }`}
                onClick={() => handleSectionClick('Blogsandcourse')}
              >
                <Image src="/Images/schoolicon.svg" alt="school" width={24} height={24} />
                <p className={styled.homenames}>Blogs and Courses</p>
              </div>
              <div
                className={`${styled.namebackground} ${
                  selectedSection === 'Hackathon' ? styled.selectedOption : ''
                }`}
                onClick={() => handleSectionClick('Hackathon')}
              >
                <Image src="/Images/trophy.svg" alt="trophy" width={24} height={24} />
          ...
          <div className={styled.update}>
            <div className={styled.updatebox}>
              ...
              <Button
                ...
                onClick={() => handleSectionClick('Updatepro')}
              >
                Upgrade to Pro
              </Button>
            </div>
              ...
              <div className={styled.card}>
                ...
                ></iframe>
                  ...
                  <div style={{ marginTop: '14px' }}>
                    <Typography
                      className={styled.courseinclude}
